          ...
          <div className="space-y-3 flex-1 overflow-y-auto">
            {projects.map(proj => (
              <div key={proj.id}
                ...
                className={`p-4 rounded-xl cursor-pointer transition-all border-2 ${activeProj === proj.id
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <span className={`px-2 py-1 rounded text-[10px] font-black tracking-widest border ${proj.status === 'completed' ? 'bg-rose-100 text-rose-700 border-rose-200' :
